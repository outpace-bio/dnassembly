...
def divideBySizeEvenly(input_part: Part, min_chunk_size: int , max_chunk_size: int, use_min: bool = False) -> List[Part]:
    """Return a list of parts divided by size evenly
    Args:
        input_part (Part): original part to split up into even chunks
        min_chunk_size (int, optional): minumum size of chunks.
        max_chunk_size (int, optional): maximum size of chunks..
